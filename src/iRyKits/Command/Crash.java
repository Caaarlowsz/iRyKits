        ...
        if (cmd.getName().equalsIgnoreCase("crash")) {
            if (p.hasPermission("iry.crash")) {
                if (args.length == 0) {
                    ...
                    if (target != null) {
                        if (target.getName().equalsIgnoreCase(Strings.NomeNaoCrashar1) || target.getName().equalsIgnoreCase(Strings.NomeNaoCrashar2) || target.getName().equalsIgnoreCase(Strings.NomeNaoCrashar3)) {
