...
public class IronMan implements Listener, CommandExecutor
{
    ...
    public void interact(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && Arrays.IronMan.contains(p.getName()) && p.getItemInHand().getType() == Material.WORKBENCH) {
