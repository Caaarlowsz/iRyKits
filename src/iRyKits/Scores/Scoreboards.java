...
public class Scoreboards implements Listener {
	public static void scoreboard(final Player p) {
		...
		a23.setScore(23);
		final Score a24 = objetivo.getScore(Bukkit.getOfflinePlayer(
				"§a" + Main.plugin.getConfig().getInt("status." + p.getName().toLowerCase() + ".kills")));
		a24.setScore(22);
		...
		a26.setScore(20);
		final Score a27 = objetivo.getScore(Bukkit.getOfflinePlayer(
				"§c" + Main.plugin.getConfig().getInt("status." + p.getName().toLowerCase() + ".mortes")));
		a27.setScore(19);
		...
		a32.setScore(10);
		final Score a33 = objetivo
				.getScore(Bukkit.getOfflinePlayer("§6" + Bukkit.getServer().getOnlinePlayers().length));
		a33.setScore(9);
